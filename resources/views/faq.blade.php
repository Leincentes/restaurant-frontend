        ...
        <div class='faq_wrapper'>
          <ul class='items'>
            <li>
              ...
              <ul class='sub-items'>
                <li>
                  <p class="half_space"> Please call us on +63-992-477-5529 or write email to packaging@desu.org mentioning your Order #.</p>
                </li>
              </ul>
            </li>
            <li>
            ...
            <li>
              ...
              <ul class='sub-items'>
                <li>
                  <p class="half_space">Orders are delivered directly by the Desu Packaging Assist suppliers. Different items in an order could be fulfilled by different suppliers. We will share the contact details and amount payable for all deliveries via email and SMS.</p>
                </li>
              </ul>
            </li>
            <li>
