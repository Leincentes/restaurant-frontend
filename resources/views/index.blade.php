    ...
    <div id="rev_slider_34_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
        <ul>    <!-- SLIDE  -->
            <li data-index="rs-129" data-transition="fade" data-slotamount="default" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7"  data-title="Fish &nbsp; Steak" data-description="Enjoy Delicious Food!">
                <!-- MAIN IMAGE -->
                <img src="public/images/banner2.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                <!-- LAYER NR. 2 -->
            ...
            <li class="text-center" data-index="rs-130" data-transition="slideleft" data-slotamount="default" data-rotate="0"  data-title="Bakery &nbsp; Items" data-description="Enjoy Delicious Food!">
                <img src="public/images/banner1.jpg"  alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                <h1 class="tp-caption tp-resizeme" 
                ...
                <p class="tp-caption tp-resizeme"
                    ...
                    <li class="text-right" data-index="rs-131" data-transition="slideleft"   data-rotate="0" data-title="Fresh &nbsp; Food" data-description="Enjoy Delicious Food!">
                        <img src="public/images/banner4.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                <h1 class="tp-caption tp-resizeme" 
    ...
    <div class="row">
      <div class="col-md-8">
        ...
        <div id="service-slider" class="owl-carousel">
          <div class="item">
            ...
            <div class="image">
              <img src="public/images/food-1.jpg" alt="Services Image">
          ...
          <div class="item">
            <div class="item_inner">
              <div class="image">
              <img src="public/images/food-2.jpg" alt="Services Image">
              <a  href="./account/register.php"></a>
              </div>
          ...
          <div class="item">
            <div class="item_inner">
              <div class="image">
              <img src="public/images/food-3.jpg" alt="Services Image">
              <a  href="./account/register.php"></a>
              </div>
          ...
          <div class="item">
            <div class="item_inner">
              <div class="image">
              <img src="public/images/food-4.jpg" alt="Services Image">
              <a  href="./account/register.php"></a>
              </div>
      ...
      <div class="col-md-4">
        ...
        <ul class="menu_widget">
          <li>Classic Nachos<span>PHP 499.00</span></li>
          <li>Nachos Grande<span>PHP 249.00</span></li>
          <li>Avocado Shell Stuffed<span>PHP 150.00</span></li>
          <li>Stuffed Mushroom<span>PHP 199.00</span></li>
          <li>Baked Potato Jackets<span>PHP 99.00</span></li>
          <li>Mexican Taco<span>PHP 899.00</span></li>
          <li>Tex-Mex Chicken<span>PHP 1250.00</span></li>
          <li>Quesadillas Acapulco<span>PHP 399.00</span></li>
        </ul>
          ...
          <div class="wrap-content clearfix home-gallery">
            <div class="col-1-4 mix work-item drinks">
              <div class="wrap-col">
                <div class="item-container">
                  <div class="image">
                    <img src="public/images/gallery1.jpg" alt="cook"/>
                    <div class="overlay">
            ...
            <div class="col-1-4 mix work-item starters">
              <div class="wrap-col">
                <div class="item-container">
                  <div class="image">
                    <img src="public/images/galler2.jpg" alt="cook"/>
                    <div class="overlay">
                        <a class="fancybox overlay-inner" href="public/images/galler2.jpg" data-fancybox-group="gallery"><i class=" icon-eye6"></i></a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-1-4 mix work-item dinner">
              <div class="wrap-col">
                <div class="item-container">
                  <div class="image">
                    <img src="public/images/gallery3.jpg" alt="cook"/>
                    <div class="overlay">
                        <a class="fancybox overlay-inner" href="public/images/gallery3.jpg" data-fancybox-group="gallery"><i class=" icon-eye6"></i></a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-1-4 mix work-item drinks">
              <div class="wrap-col">
                <div class="item-container">
                  <div class="image">
                    <img src="public/images/gallery4.jpg" alt="cook"/>
                    <div class="overlay">
                        <a class="fancybox overlay-inner" href="public/images/gallery4.jpg" data-fancybox-group="gallery"><i class=" icon-eye6"></i></a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-1-4 mix work-item dinner">
              <div class="wrap-col">
                <div class="item-container">
                  <div class="image">
                    <img src="public/images/gallery5.jpg" alt="cook"/>
                    <div class="overlay">
                        <a class="fancybox overlay-inner" href="public/images/gallery5.jpg" data-fancybox-group="gallery"><i class=" icon-eye6"></i></a>
                    </div> 
                  </div>
                </div>
              </div>
            ...
            <div class="col-1-4 mix work-item lunch">
              <div class="wrap-col">
                <div class="item-container">
                  <div class="image">
                    <img src="public/images/gallery6.jpg" alt="cook"/>
                    <div class="overlay">
                        <a class="fancybox overlay-inner" href="public/images/gallery6.jpg" data-fancybox-group="gallery"><i class=" icon-eye6"></i></a>
                    </div>
                  </div> 
                </div>
              </div>
            ...
            <div class="col-1-4 mix work-item starters">
              <div class="wrap-col">
                <div class="item-container">
                  <div class="image">
                    <img src="public/images/gallery7.jpg" alt="cook"/>
                    <div class="overlay">
                        <a class="fancybox overlay-inner" href="public/images/gallery7.jpg" data-fancybox-group="gallery"><i class=" icon-eye6"></i></a>
                    </div>
                  </div> 
                </div>
              </div>
            ...
            <div class="col-1-4 mix work-item starters">
              <div class="wrap-col">
                <div class="item-container">
                  <div class="image">
                    <img src="public/images/gallery8.jpg" alt="cook"/>
                    <div class="overlay">
                        <a class="video fancybox.iframe overlay-inner" href="https://player.vimeo.com/video/94224205?autoplay=1"><i class=" icon-eye6"></i></a>
                    </div>
                  </div>
          ...
          <div id="our-cheffs" class="owl-carousel">
            <div class="item">
              <div class="cheffs_wrap">
               <img src="public/images/our-cheffs1.jpg" alt="Kitchen Staff">
               <h3>Stafeny Rose</h3>
            ...
            <div class="item">
              <div class="cheffs_wrap">
               <img src="public/images/our-cheffs2.jpg" alt="Kitchen Staff">
            ...
            <div class="item">
              <div class="cheffs_wrap">
               <img src="public/images/our-cheffs3.jpg" alt="Kitchen Staff">
               <h3>Angle Maria</h3>
          ...
          <div id="news-slider" class="owl-carousel">
            <div class="item">
              <div class="news_content">
               <img src="public/images/news-img3.jpg" alt="Docotor">
            ...
            <div class="item">
              <div class="news_content">
               <img src="public/images/news-img2.jpg" alt="Docotor">
               <div class="date_comment">
                  <span>22<small>apr</small></span>
                  <a href="#."><i class="icon-comment"></i> 5</a>
               </div>
            ...
            <div class="item">
              <div class="news_content">
               <img src="public/images/news-img1.jpg" alt="Docotor">
               <div class="date_comment">
                  <span>22<small>apr</small></span>
                  <a href="#."><i class="icon-comment"></i> 5</a>
               </div>
            ...
            <div class="item">
              <div class="news_content">
               <img src="public/images/food-1.jpg" alt="Docotor">
               <div class="date_comment">
                  <span>22<small>apr</small></span>
                   <a href="#."><i class="icon-comment"></i> 5</a>
               </div>
